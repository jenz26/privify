...
The second is the pixel-level irreversibility of the blur: the blurred region
replaces the original pixels in the output frame, without preserving recoverable
information about the original pixels in the output format. The output video is
therefore a distinct datum from the input video, and the input video can be deleted
after processing without compromising the usability of the output. This choice is
...
automatically on biometric data (even if not for identification purposes) may
...
(McPherson, Shokri, Shmatikov, 2016; more recent: Maximov et al., 2020 on deep
learning based deblurring) has demonstrated that blur techniques applied to face
